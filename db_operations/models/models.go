...
// TODO create time value
type Policy struct {
	ID          int64              `db:"id"`
	AppID       int32              `db:"app_id"`
	UserID      int32              `db:"user_id"`
	Rules       pgtype.JSONB       `db:"rules"`
	DateCreated pgtype.Timestamptz `db:"date_created"` // TODO update DB schema
	DateChanged pgtype.Timestamptz `db:"date_changed"` // TODO update DB schema
}
